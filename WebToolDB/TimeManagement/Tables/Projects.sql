CREATE TABLE [TimeManagement].[Projects] (
	...
	CONSTRAINT [FK_Projects_CustomerRef] FOREIGN KEY ([FK_CustomerRef]) REFERENCES [TimeManagement].[CustomerRef] ([PK_Id]),
    CONSTRAINT [FK_Projects_Requester] FOREIGN KEY ([FK_Requester]) REFERENCES [TimeManagement].[Requester] ([PK_Id]),
    CONSTRAINT [FK_Projects_RequestOrg] FOREIGN KEY ([FK_RequestOrg]) REFERENCES [TimeManagement].[RequestOrg] ([PK_Id])
